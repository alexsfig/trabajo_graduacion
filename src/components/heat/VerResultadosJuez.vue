...
<div>
    ...
    <section class="content">
            ...
            <div class="col-lg-12">
                <div class="box box-primary">
                    <div class="box-header with-border text-center">
                        <hr class="hr-title" v-bind:data-content="'Circuito ' + heat.rondaId.circuitoId.nombre">
                        <h4 >Heat: <b>{{heat.numero}}</b>. Ronda: <b>{{heat.rondaId.numero}} </b>. Estado: <b>{{heat.estado}} </b></h4>
                    </div>
                    <div class="box-body">
                        <div class="pull-right">
                            <toggle-button v-model="verTodo" :sync="true" :value="verTodo" :width="130" :height="35" id="changed-font" :labels="{checked: 'Ver todos ', unchecked: 'Solo Resumen'}" :color="{checked: '#37b53c', unchecked: '#545bb3'}" />
                        ...
                        <div class="heat-notes">
                            <hr class="hr-text" data-content="Resultados del Heat">
                            <vue-good-table :columns="columnsResult" :rows="resumen" :paginate="true" :globalSearch="false" globalSearchPlaceholder="Search" styleClass="table table-striped table-condensed">
                                <template slot="table-row" scope="props">
                                    ...
                                    <td v-if="props.row.color=='Rojo'" class="redBG">{{ props.row.color }}</td>
                                    <td>
                                        <router-link :to="{ name: 'AtletasShow', params: { id: props.row.atletaId }}">
        ...
        <modalNota :title="'Calificar'" :buttonMsg="'Actualizar'" :openModal="openModal" :atletaHeat="atletaHeat" v-on:openChange="isChange">
        </modalNota>
...
this.errMsg="El heat aun no tiene calificaciones "
     ...
     */
            ...
            deleteHeat(id, nombre) {
                ...
                this.$swal({
                    title: "Estas Seguro?",
                    html: "No podras recuperar la informacion de la heat <b>&laquo;" +
                        nombre +
