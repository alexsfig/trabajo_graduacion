                            ...
                            <form @submit.prevent="submit" role="form">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="fgroup required" :class="{ 'has-error': errors.has('categoria') }">
                                        ...
                                        <v-select :debounce="250" :options="categorias" v-model="categoria" placeholder="Selecciona un categoria" label="nombreCategoria">
                                        </v-select>
                                        ...
                                        <button type="submit" class="btn btn-flat btn-sm btn-primary"><i aria-hidden="true" class="fa fa-search"></i> Buscar </button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="box-body">
                        <vue-good-table theme="nocturnal" :columns="columns" :rows="ranking" :paginate="true" :globalSearch="true" globalSearchPlaceholder="Search" styleClass="table table-striped table-condensed">
                            <template slot="table-row" scope="props">
                                <td style="">
                                    <router-link :to="{ name: 'AtletasShow', params: { id: props.row.atleta }}"><img class="custom-img img-responsive img-circle" v-bind:src="getImg(props.row.atleta)" alt="User profile picture" /></router-link>
                                </td>
