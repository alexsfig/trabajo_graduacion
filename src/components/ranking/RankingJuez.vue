           ...
           <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="box-body">
                         <vue-good-table   theme="nocturnal" :columns="columns" :rows="ranking" :paginate="true" :globalSearch="true" globalSearchPlaceholder="Search" styleClass="table table-striped table-condensed">
                               ...
                               <td style=""><router-link :to="{ name: 'AtletasShowJuez', params: { id: props.row.atleta }}"><img class="custom-img img-responsive img-circle" v-bind:src="getImg(props.row.atleta)" alt="User profile picture"/></router-link></td>
