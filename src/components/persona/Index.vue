                                ...
                                <td>
                                    ...
                                    <div v-if="!props.row.juez">
                                        <router-link :to="{ name: 'juezAdd', params: { id: props.row.id }}">
                                            <button type="button" :title="'Crear'" class="btn btn-primary-outline"><i aria-hidden="true" class="fa fa-plus"></i> </button>
                                        </router-link>
                                    </div>
                                    <div v-if="props.row.juez">
        ...
        fetchData() {
            ...
            _atleta(val, row) {
                ...
                if (val != 0) {
                    config1 = {
                        title: "Editar?",
                        html: "Deseas editar la informacion de atleta de la persona <b>&laquo;" +
                            row.nombre +
                            "&raquo</b>",
                        type: "success",
                    ...
                    config1 = {
                        title: "Crear?",
                        html: "Deseas crear la informacion de atleta a partir de la persona <b>&laquo;" +
                            row.nombre +
                            "&raquo</b>",
                        type: "success",
                        showCancelButton: true,
            ...
            deletePersona(id, nombre) {
                ...
                this.$swal({
                    title: "Estas Seguro?",
                    html: "No podras recuperar la informacion de la Persona <b>&laquo;" +
                        nombre +
            ...
            deleteAtleta(id, nombre) {
                ...
                this.$swal({
                    title: "Estas Seguro?",
                    html: "No podras recuperar la informacion del Atleta <b>&laquo;" +
                        nombre +
                        "&raquo</b><br>y toda la informacion en relacion al mismo ya no sera accesible",
                    type: "error",
                    showCancelButton: true,
            ...
            deleteEntrenador(id, nombre) {
                ...
                this.$swal({
                    title: "Estas Seguro?",
                    html: "No podras recuperar la informacion del entrenador <b>&laquo;" +
                        nombre +
            ...
            deleteMiembro(id, nombre) {
                ...
                this.$swal({
                    title: "Estas Seguro?",
                    html: "No podras recuperar la informacion del miembro de junta <b>&laquo;" +
                        nombre +
                        "&raquo</b><br>y toda la informacion relacion al mismo ya no sera accesible",
                    type: "error",
                    showCancelButton: true,
            ...
            deleteJuez(id, nombre) {
                ...
                this.$swal({
                    title: "Estas Seguro?",
                    html: "No podras recuperar la informacion del juez <b>&laquo;" +
                        nombre +
                        "&raquo</b><br>y toda la informacion relacion al mismo ya no sera accesible",
                    type: "error",
                    showCancelButton: true,
