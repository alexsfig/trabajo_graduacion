                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="fgroup">
                                                        ...
                                                        <span id="management-avatar" style="display:inline-block">
                                                            <button :disabled="use_default_avatar" id="" type="button" class="btn btn-primary btn-flat btn-lg margin" @click="toggleShow">
...
export default {
    ...
    created() {
        ...
        this.createAtleta.ruta_foto =  "/assets/images/persona/atleta/"+this.filename+".png"
        this.fetchData()
