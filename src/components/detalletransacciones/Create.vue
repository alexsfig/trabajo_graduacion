<template>
    <div>
        <section class="content-header">
            <h1>Detalle Transacciones</h1>
            <ol class="breadcrumb">
                
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><router-link to="/admin/categorias">Detalle Transacciones</router-link></li>
                <li class="active">Registrar Detalle Transaccion</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Registrar Detalle Transaccion</h3>
                        </div>
