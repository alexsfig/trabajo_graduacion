<template>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                         ...
                         <div class="fgroup" :class="{ 'has-error': errors.has('nombre') }" >
											...
											v-model="formaPago.nombre" v-validate="'required'" >
 ...
 <div class="col-xs-12 col-sm-6">
                         <div class="fgroup" :class="{ 'has-error': errors.has('descripcion') }" >
											...
											v-model="formaPago.descripcion" v-validate="'required'" >
...
<script>  import formaPagosController from '../../controllers/formaPagos.js'
