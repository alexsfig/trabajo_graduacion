...
<div>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box box-primary">
                    <div class="box-header with-border" v-if="transaccion.inicio != null">
                        <h3 class="box-title">Transacciones Registradas Desde: <b>{{transaccion.inicio}}</b> Hasta: <b>{{transaccion.fin}} </b></h3>
                    </div>
                    <div class="box-header with-border" v-if="transaccion.patrocinadorId != null">
    ...
    watch: {
        ...
        patrocinador: function(val) {
            if (this.id) {
                ...
                this.transaccion.patrocinadorId = {
                    id: this.id,
                    nombre: val.nombre
                };
