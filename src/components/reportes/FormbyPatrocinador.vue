                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <vue-good-table  id="basic-table" :columns="columns" :rows="searchs"
                             :paginate="true" :globalSearch="true"
                              globalSearchPlaceholder="Search" styleClass="table table-striped table-condensed"
...
export default {
  ...
  watch: {
    ...
    patrocinador: function(val) {
      if (this.id) {
        ...
        this.transaccion.patrocinadorId = { id: this.id, nombre: val.nombre };
  ...
  created() {
    ...
    if (this.id) {
      patrocinadoresController.retrieve(this, this.id);
      //transaccionsController.retrieve(this, this.id);
      //transaccionsController.retrieve(this, this.entrada);
