                        ...
                        <form @submit.prevent="submit" role="form">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-4" v-if="formaPagos instanceof Array">
                                        <div class="fgroup">
                                    ...
                                    <div class="col-xs-12 col-sm-4" v-if="cuentas instanceof Array">
                                        <div class="fgroup">
                                    ...
                                    <div class="col-xs-12 col-sm-4" v-if="tipoTransaccions instanceof Array">
                                        <div class="fgroup">
                                    ...
                                    <div class="col-xs-12 col-sm-4" v-if="naturaleza instanceof Array">
                                        <div class="fgroup">
                                ...
                                <div class="row">
                                    <h4>Patrocinadores y Atletas</h4>
                            ...
                            <div class="box-footer">
                                <div class="col-xs-12 text-right">
                                    ...
                                    <button type="submit" v-if="!id" class="btn btn-flat btn-sm btn-primary"><i aria-hidden="true" class="fa fa-search"></i> Consultar</button>
