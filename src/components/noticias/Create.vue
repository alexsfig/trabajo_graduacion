                            ...
                            <form @submit.prevent="submit" role="form">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <!-- <my-upload field="img" @crop-success="cropSuccess" @crop-upload-success="cropUploadSuccess" @crop-upload-fail="cropUploadFail" v-model="showAvatar" :params="params" lang-type="en" :headers="headers" img-format="png">
                                        </my-upload> -->
                                        <input type="file" @change="onFileChanged" class="btn btn-primary btn-flat btn-md margin" >
